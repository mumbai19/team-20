...
<body>
	...
	<!-- Category section -->
	<section class="category-section spad text-center">
		<!-- <div class="container">
			<div class="row">
				...
				<div class="col-lg-9  order-1 order-lg-2 mb-5 mb-lg-0 " style="margin: auto;">
					<div class="row">
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									...
									<div class="pi-links">
										<a href="{{url('/asia/japan')}}" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								</div>
								<div class="pi-text">
